...
const products = [
  {
    ...
    bg: "src/assets/industrialChemical.jpg",
    button: "View Trips",
  },
  {
    ...
    bg: "src/assets/constructionChemical.jpg",
    button: "View Trips",
  },
  {
    ...
    bg: "src/assets/Beauty_Personal_Care_chemicals.jpg",
    button: "View Trips",
  },
  {
    ...
    bg: "src/assets/Food&FeedAdditives.jpg",
    button: "View Trips",
  },
  {
    ...
    bg: "src/assets/SpecialityChemicals.jpg",
    button: "View Trips",
  },
  {
    ...
    bg: "src/assets/PharmaIntermediates.jpg",
    button: "View Trips",
  },
  {
    ...
    bg: "src/assets/OtherTradingImportedMaterials.webp",
    button: "View Trips",
  },
];
...
export default function HomePage() {
  ...
  return (
    <>
      <div className="mx-auto max-w-2xl min-h-[80vh] flex flex-col justify-center items-center px-4">
